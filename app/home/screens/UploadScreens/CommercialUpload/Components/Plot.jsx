...
//   const [plotKind, setPlotKind] = useState(""); // ✅ ADD THIS
...
//           if (parsed.plotKind) {
//             setPlotKind(parsed.plotKind);
//           } else if (plotKindFromParams) {
//             setPlotKind(plotKindFromParams);
//           }
...
//           console.log('✅ Plot draft loaded successfully');
//           console.log('✅ plotKindFromParams:', plotKindFromParams); // ✅ ADD THIS LOG
//           return;
//         }
//       } catch (e) {
