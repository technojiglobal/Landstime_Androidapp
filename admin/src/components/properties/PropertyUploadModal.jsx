...
case 'Commercial':
return <div className="text-center py-8 text-gray-500">Commercial form coming soon...</div>;
case 'Resort':
return <div className="text-center py-8 text-gray-500">Resort form coming soon...</div>;
default:
return null;
}
};
