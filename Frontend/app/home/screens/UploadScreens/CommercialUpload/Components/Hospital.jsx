...
import AddFurnishingsScreen from "./AddFurnishingsScreen";
...
export default function UploadPropertyScreen() {
  ...
  const [qualityRating, setQualityRating] = useState('No Rating');
  const [isFurnishingModalVisible, setFurnishingModalVisible] = useState(false);

  // ✅ Options
 
  const storageKindPills = ['Hostels/Resorts', 'Guest-House/Banquet-Halls'];
  ...
  const qualityRatingOptions = ["1 Star", "2 Star", "3 Star", "4 Star", "5 Star", "6 Star", "7 Star", "No Rating"];
        ...
        <View className="bg-white rounded-lg p-4 mb-4" style={{ borderWidth: 1, borderColor: "#0000001A" }}>
          ...
          <View className="flex-row gap-2 mb-4">
            <View className="flex-1">
              ...
              <TextInput
                placeholder="0"
                className="rounded-md p-3 text-gray-800 text-left"
          ...
          <View className="flex-row gap-2 mb-4">
            <View className="flex-1">
              ...
              <TextInput placeholder="0" className="rounded-md p-3 text-gray-800 text-left" keyboardType="numeric" style={{ borderWidth: 1, borderColor: "#0000001A", height: 50, backgroundColor: "#D9D9D91C" }} />
            </View>
            <View className="flex-1">
          ...
          <View className="flex-1 mb-2">
            <Text className="text-gray-500 font-semibold mb-2 text-left">Balconies</Text>
            <TextInput
              placeholder="0"
              className="rounded-md p-3 text-gray-800 text-left"
              keyboardType="numeric"
          ...
          <Text className="text-[15px] text-[#00000099] font-bold mb-2 mt-2">Furnishing</Text>
          <View className="flex-row flex-wrap">
            {furnishingOptions.map((o) => (
              <PillButton
                key={o}
                label={o}
                selected={furnishing === o}
                onPress={() => {
                  setFurnishing(o);
                  if (o === "Semi-furnished" || o === "Furnished") {
                    setFurnishingModalVisible(true);
                  }
                }}
              />
            ))}
          </View>
          <Modal visible={isFurnishingModalVisible} transparent={true} animationType="slide">
            <AddFurnishingsScreen
              onClose={() => setFurnishingModalVisible(false)}
            />
          </Modal>
    ...
    {showMonthDropdown && (
      <>
        ...
        {visible === "expectedMonth" && (
          ...
          <Text className="text-[15px] text-[#00000099] font-bold mb-2 mt-2">Quality Rating</Text>
          <View className="flex-row flex-wrap">
            {qualityRatingOptions.map((o) => (
              <PillButton key={o} label={o} selected={qualityRating === o} onPress={() => setQualityRating(o)} />
            ))}
          </View>
