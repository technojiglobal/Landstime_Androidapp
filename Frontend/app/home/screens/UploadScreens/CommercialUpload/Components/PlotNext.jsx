...
export default function PlotNext() {
  ...
  const amenitiesOptions = [
    t('plot_amenity_water'),
    t('plot_amenity_air_conditioned'),
    t('plot_amenity_vaastu'),
    t('plot_amenity_fire_alarm'),
    t('plot_amenity_parking'),
  ];

  const locationAdvOptions = [
    t('plot_location_metro'),
    t('plot_location_school'),
    t('plot_location_hospital'),
    t('plot_location_market'),
    t('plot_location_railway'),
    t('plot_location_airport'),
    t('plot_location_mall'),
    t('plot_location_highway'),
  ];
  ...
  const handleNext = () => {
    ...
    const convertedData = {
      ...
      amenities: convertToEnglish(amenities),
      locationAdvantages: convertToEnglish(locationAdvantages),
    };
