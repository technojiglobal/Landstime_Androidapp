...
export default function OverviewScreen() {
  ...
  const { propertyId, areaKey, propertyData } = useLocalSearchParams();  // ✅ Get propertyData
...
const handleContactAgent = async () => {
  try {
    ...
    const overviewRoute = '/home/screens/Sites/(Property)'; // ✅ ADD THIS - current overview route
    ...
    const overviewRoute = '/home/screens/Sites/(Property)';
    const backRoute = property?.propertyType === 'Resort' ? '/home/screens/Resorts/PropertyDetails' :
                      ...
                      '/home/screens/Sites/PropertyDetails';
