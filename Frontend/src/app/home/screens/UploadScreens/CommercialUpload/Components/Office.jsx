...
export default function PropertyFormScreen() {
  ...
  // Features
  const [conferenceSelected, setConferenceSelected] = useState(true);
  const [washroomSelected, setWashroomSelected] = useState(null);
  ...
  const [prevUsed, setPrevUsed] = useState(null);
    ...
    {[
      ...
      >
        ...
        >
          ...
          <Checkbox
            label="WashRoom"
            selected={!!washroomSelected}
            onPress={() => setWashroomSelected(washroomSelected ? null : '1')}
          />
           {!!washroomSelected && <View className="flex-row mb-4">
            {conferenceOptions.map((o) => (
              <RoundOption key={o} label={o} selected={washroomSelected === o} onPress={() => setWashroomSelected(o)} />
            ))}
          </View>}
