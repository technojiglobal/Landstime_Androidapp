    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white', paddingTop: insets.top }}>
      ...
      <View className="bg-white">
        <View className="flex-row items-center py-3 px-4">
          <TouchableOpacity className="p-1" onPress={() => router.push('/home/screens/Commercial')}>
        ...
        <View className="px-4 pb-2">
          <View style={styles.searchBar}>
            ...
            <TouchableOpacity
              className="p-2"
              onPress={() => router.push('/home/screens/Commercial/Voice')}
            >
            ...
            <TouchableOpacity
              className="p-2"
              onPress={() => router.push('/home/screens/Commercial/Filter')}
            >
